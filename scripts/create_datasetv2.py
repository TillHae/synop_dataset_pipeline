...
class NumericalChecker:
    ...
    def plot_completeness_heatmap(self, output_dir: str):
        ...
        plt.xlabel('Data Completeness (%)', fontsize=48)
        plt.ylabel('Variable', fontsize=48)
    ...
    def plot_nan_percentages(self, output_dir: str):
        ...
        plt.xticks(range(len(vars_sorted)), vars_sorted, rotation=45, ha='right', fontsize=48)
        plt.xlabel('Variable', fontsize=48)
        plt.ylabel('Missing Data (%)', fontsize=48)
    ...
    def plot_stationarity_results(self, output_dir: str):
        ...
        plt.xticks(range(len(vars_sorted)), vars_sorted, rotation=45, ha='right', fontsize=48)
        plt.xlabel('Variable', fontsize=48)
        plt.ylabel('Coefficient of Variation (Mean)', fontsize=48)
    ...
    def plot_variance_results(self, output_dir: str):
        ...
        plt.xticks(range(len(vars_sorted)), vars_sorted, rotation=45, ha='right', fontsize=48)
        plt.xlabel('Variable', fontsize=48)
        plt.ylabel('Variance Ratio (Max/Min)', fontsize=48)
        plt.tick_params(axis='y', which='major', labelsize=48)
    ...
    def plot_range_violations(self, output_dir: str):
        ...
        plt.xticks(range(len(vars_sorted)), vars_sorted, rotation=45, ha='right', fontsize=48)
        plt.xlabel('Variable', fontsize=48)
        plt.ylabel('Out-of-Range Values (%)', fontsize=48)
        plt.tick_params(axis='y', which='major', labelsize=48)
    ...
    def plot_distribution_results(self, output_dir: str):
        ...
        ax1.set_xlabel('KS Test p-value', fontsize=48)
        ax1.set_ylabel('Variable', fontsize=48)
        ...
        ax2.set_xticklabels(vars_sorted2, rotation=45, ha='right', fontsize=48)
        ax2.set_ylabel('Normal Distribution (%)', fontsize=48)
        ax2.set_xlabel('Variable', fontsize=48)
        ...
        ax3.set_xlabel('Skewness', fontsize=48)
        ax3.set_ylabel('Variable', fontsize=48)
        ...
        ax3.legend(loc='lower right', fontsize=48)
        ...
        ax4.set_xlabel('Excess Kurtosis', fontsize=48)
        ax4.set_ylabel('Variable', fontsize=48)
        ...
        ax4.legend(loc='lower right', fontsize=48)
        ...
        for var_name in distribution_data['skewness'].keys():
            ...
            ax.annotate(var_name, (avg_skew, avg_kurt), fontsize=36, xytext=(5, 5), textcoords='offset points', alpha=0.8)
...
class NumericalApplier:
    ...
    def plot_cleaning_impact(self, output_dir: str = "plots/v2"):
        ...
        plt.xticks(range(len(vars_sorted)), vars_sorted, rotation=45, ha='right', fontsize=48)
        plt.xlabel('Variable', fontsize=48)
        plt.ylabel('Data Removed (%)', fontsize=48)
