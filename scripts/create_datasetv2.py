...
class NumericalChecker:
    ...
    def plot_completeness_heatmap(self, output_dir: str):
        ...
        plt.xlabel('Data Completeness (%)', fontsize=24)
    ...
    def plot_nan_percentages(self, output_dir: str):
        ...
        plt.ylabel('Missing Data (%)', fontsize=24)
    ...
    def plot_variance_results(self, output_dir: str):
        ...
        plt.xticks(range(len(vars_sorted)), vars_sorted, rotation=45, ha='right')
        plt.xlabel('Variable', fontsize=24)
        plt.ylabel('Variance Ratio (Max/Min)', fontsize=24)
        plt.tick_params(axis='y', which='major')
    ...
    def plot_range_violations(self, output_dir: str):
        ...
        plt.xticks(range(len(vars_sorted)), vars_sorted, rotation=45, ha='right')
        plt.xlabel('Variable', fontsize=24)
        plt.ylabel('Out-of-Range Values (%)', fontsize=24)
        plt.tick_params(axis='y', which='major')
    ...
    def plot_distribution_results(self, output_dir: str):
        ...
        ax1.set_xlabel('KS Test p-value', fontsize=24)
        ax1.set_ylabel('Variable', fontsize=24)
        ...
        ax2.set_xticklabels(vars_sorted2, rotation=45, ha='right', fontsize=24)
        ax2.set_ylabel('Normal Distribution (%)', fontsize=24)
        ax2.set_xlabel('Variable', fontsize=24)
        ...
        ax3.set_xlabel('Skewness', fontsize=24)
        ax3.set_ylabel('Variable', fontsize=24)
        ...
        ax4.set_xlabel('Excess Kurtosis', fontsize=24)
        ax4.set_ylabel('Variable', fontsize=24)
        ...
        for var_name in distribution_data['skewness'].keys():
            ...
            ax.annotate(var_name, (avg_skew, avg_kurt), fontsize=18, xytext=(5, 5), textcoords='offset points', alpha=0.8)
