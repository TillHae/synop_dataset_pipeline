...
def plot_interpolation_summary(all_results: list, output_dir: str = "plots/v4"):
    ...
    plt.ylabel('Fill Success Rate (%)', fontsize=24)
    ...
    plt.xlabel('Variable', fontsize=24)
    plt.ylabel('Number of NaN Values', fontsize=24)
    # plt.title('NaN Count Before and After Gap Filling', fontsize=14, fontweight='bold')
    plt.xticks(x, vars_sorted, rotation=45, ha='right', fontsize=24)
    plt.tick_params(axis='y', which='major', labelsize=24)
    ...
    plt.xlabel('Variable', fontsize=24)
    plt.ylabel('Number of Values Filled', fontsize=24)
