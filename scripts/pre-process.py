...
def plot_duplicates(all_dups):
    ...
    plt.ylabel('Files with Duplicates (%)', fontsize=24)
    ...
    plt.xlabel('Variable Category', fontsize=24)
    plt.ylabel('Overlapping Time (%)', fontsize=24)
    plt.tick_params(axis='both', which='major')
    plt.grid(axis='y', linestyle='--', alpha=0.7)
    plt.tight_layout()
...
def plot_missing(total_missing):
    ...
    plt.xlabel('Variable Category', fontsize=24)
    plt.ylabel('Files with Missing Data (%)', fontsize=24)
    plt.tick_params(axis='both', which='major')
    plt.grid(axis='y', linestyle='--', alpha=0.7)
    plt.tight_layout()
    ...
    plt.xlabel('Variable Category', fontsize=24)
    plt.ylabel('Missing Time (%)', fontsize=24)
    plt.tick_params(axis='both', which='major')
    plt.grid(axis='y', linestyle='--', alpha=0.7)
    plt.tight_layout()
...
def plot_incorrect(incorrect):
    ...
    plt.xlabel('Variable Category', fontsize=24)
    plt.ylabel('Files with Incorrect Content (%)', fontsize=24)
    plt.tick_params(axis='both', which='major')
    plt.grid(axis='y', linestyle='--', alpha=0.7)
    plt.tight_layout()
    ...
    plt.xlabel('Variable Category', fontsize=24)
    plt.ylabel('Incorrect Time (%)', fontsize=24)
    plt.tick_params(axis='both', which='major')
    plt.grid(axis='y', linestyle='--', alpha=0.7)
    plt.tight_layout()
...
def plot_concatenations(concat_stats):
    ...
    plt.xlabel('Variable Category', fontsize=24)
    plt.ylabel('Stations Requiring Concatenation (%)', fontsize=24)
    plt.tick_params(axis='both', which='major')
    plt.grid(axis='y', linestyle='--', alpha=0.7)
    plt.tight_layout()
