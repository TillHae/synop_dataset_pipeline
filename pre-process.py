...
def plot_duplicates(all_dups):
    ...
    plt.ylabel('Files with Duplicates (%)', fontsize=12)
    ...
    plt.xlabel('Variable Category', fontsize=12)
    plt.ylabel('Overlapping Time (%)', fontsize=12)
    plt.grid(axis='y', linestyle='--', alpha=0.7)
    plt.tight_layout()
...
def plot_missing(total_missing):
    ...
    plt.xlabel('Variable Category', fontsize=12)
    plt.ylabel('Files with Missing Data (%)', fontsize=12)
    plt.grid(axis='y', linestyle='--', alpha=0.7)
    plt.tight_layout()
    ...
    plt.xlabel('Variable Category', fontsize=12)
    plt.ylabel('Missing Time (%)', fontsize=12)
    plt.grid(axis='y', linestyle='--', alpha=0.7)
    plt.tight_layout()
...
def plot_incorrect(incorrect):
    ...
    plt.xlabel('Variable Category', fontsize=12)
    plt.ylabel('Files with Incorrect Content (%)', fontsize=12)
    plt.grid(axis='y', linestyle='--', alpha=0.7)
    plt.tight_layout()
    ...
    plt.xlabel('Variable Category', fontsize=12)
    plt.ylabel('Incorrect Time (%)', fontsize=12)
    plt.grid(axis='y', linestyle='--', alpha=0.7)
    plt.tight_layout()
...
def plot_concatenations(concat_stats):
    ...
    plt.xlabel('Variable Category', fontsize=12)
    plt.ylabel('Stations Requiring Concatenation (%)', fontsize=12)
    plt.grid(axis='y', linestyle='--', alpha=0.7)
    plt.tight_layout()
